...
extension DiskError {
    ...
    private static let kDAReturnError: DAReturn = 0xF8DA0001
    private static let kDAReturnBusy: DAReturn = 0xF8DA0002
    private static let kDAReturnBadArgument: DAReturn = 0xF8DA0003
    private static let kDAReturnExclusiveAccess: DAReturn = 0xF8DA0004
    private static let kDAReturnNoResources: DAReturn = 0xF8DA0005
    private static let kDAReturnNotFound: DAReturn = 0xF8DA0006
    private static let kDAReturnNotMounted: DAReturn = 0xF8DA0007
    private static let kDAReturnNotPermitted: DAReturn = 0xF8DA0008
    private static let kDAReturnNotPrivileged: DAReturn = 0xF8DA0009
    private static let kDAReturnNotReady: DAReturn = 0xF8DA000A
    private static let kDAReturnNotWritable: DAReturn = 0xF8DA000B
    private static let kDAReturnUnsupported: DAReturn = 0xF8DA000C
